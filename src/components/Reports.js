            ...
            <Box sx={{ display: 'flex', backgroundColor: "#D6D6D6", minHeight: "100vh", pt: 8 }}>
                ...
                <Container sx={{ pt: 4, pb: 8 }}>
                    <Grid container spacing={4}>
                        <Grid item xs={12}>
                            <Item>
                                <Typography variant="h5" sx={{ mb: 2, fontWeight: 'bold' }}>Monthly Review Cases Analysis</Typography>
                        ...
                        <Grid item xs={12}>
                            <Item>
                                <Typography variant="h5" sx={{ mb: 2, fontWeight: 'bold' }}>Distribution of Review Cases</Typography>
                                <Typography variant="body1" sx={{ mb: 4 }}>
                        ...
                        <Grid item xs={12}>
                            <Item>
                                <Typography variant="h5" sx={{ mb: 2, fontWeight: 'bold' }}>Successful Checks Over Time</Typography>
                                <Typography variant="body1" sx={{ mb: 4 }}>
                        ...
                        <Grid item xs={12}>
                            <Item>
                                <Typography variant="h5" sx={{ mb: 2, fontWeight: 'bold' }}>Conclusions and Recommendations</Typography>
